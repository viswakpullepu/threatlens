...
BAK_TEMPLATE = r'C:\Users\vishw\Downloads\SIH2026-IDEA-Presentation-Format (1).pptx.bak'
if not os.path.exists(BAK_TEMPLATE):
    shutil.copyfile(SRC_TEMPLATE, BAK_TEMPLATE)
    print(f"Created backup of original template at: {BAK_TEMPLATE}")

# Load presentation from backup or fresh template
prs = Presentation(BAK_TEMPLATE if os.path.exists(BAK_TEMPLATE) else SRC_TEMPLATE)
...
# ----------------------------------------------------------------------
# HELPER: Add Clean High-Contrast Oval Badge on Top-Left of Slide
# ----------------------------------------------------------------------
def apply_top_left_oval_badge(slide, slide_num):
    # 1. Remove any existing oval shape to avoid inherited theme style conflicts
...
# Add Top-Left CyberCore Oval to Slide 1
apply_top_left_oval_badge(slide1, 1)

# Format TextBox 9 on Slide 1
tb9 = None
for s in slide1.shapes:
    if s.name == "TextBox 9":
        tb9 = s
...
if tb9 and tb9.has_text_frame:
    ...
    analysis_bullets = [
        ...
        ("Corporate Data Privacy Hazard", "Forwarding corporate emails to external cloud sandbox providers violates GDPR and national data sovereignty frameworks."),
...
print("Slide 1 processed.")

# ----------------------------------------------------------------------
# SLIDES 2 TO 6: PROCESS OVALS & ADJUST TITLES
# ----------------------------------------------------------------------
for idx in range(1, 6):
    ...
    apply_top_left_oval_badge(slide, idx + 1)
...
tb_s2 = [s for s in slide2.shapes if s.name == "TextBox 8"][0]
...
p_proto2 = tf2.add_paragraph()
p_proto2.space_after = Pt(6)
r1 = p_proto2.add_run()
...
print("Slide 3 processed.")

# ----------------------------------------------------------------------
# SLIDE 4: FEASIBILITY AND VIABILITY (PARSIMONY & RISK MITIGATION)
# ----------------------------------------------------------------------
slide4 = prs.slides[3]
...
tb_s6 = [s for s in slide6.shapes if s.name == "TextBox 8"][0]
tb_s6.left = Inches(0.5)
tb_s6.top = Inches(1.3)
tb_s6.width = Inches(12.3)
tb_s6.height = Inches(5.5)
tf6 = tb_s6.text_frame
tf6.word_wrap = True
tf6.clear()

p_pa = tf6.add_paragraph()
r_pa = p_pa.add_run()
