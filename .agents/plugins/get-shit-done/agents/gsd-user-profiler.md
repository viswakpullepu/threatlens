...
<reference>
@.agents/plugins/get-shit-done/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `.agents/plugins/get-shit-done/get-shit-done/references/user-profiling.md` to load:
