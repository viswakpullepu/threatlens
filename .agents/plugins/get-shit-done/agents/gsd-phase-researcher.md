...
@.agents/plugins/get-shit-done/get-shit-done/references/thinking-models-research.md
...
```bash
node ".agents/plugins/get-shit-done/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
