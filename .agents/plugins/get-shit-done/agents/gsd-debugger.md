...
<required_reading>
@.agents/plugins/get-shit-done/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@.agents/plugins/get-shit-done/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = .agents/plugins/get-shit-done
                  → checks .agents/plugins/get-shit-done/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .agents/plugins/get-shit-done/get-shit-done
                  → writes to .agents/plugins/get-shit-done/get-shit-done/hooks/
...
@.agents/plugins/get-shit-done/get-shit-done/references/thinking-models-debug.md
...
- Read @.agents/plugins/get-shit-done/get-shit-done/references/common-bug-patterns.md
