...
Reference full template: `.agents/plugins/get-shit-done/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `.agents/plugins/get-shit-done/get-shit-done/templates/state.md`.
