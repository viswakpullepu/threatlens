...
Use template from `.agents/plugins/get-shit-done/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `.agents/plugins/get-shit-done/get-shit-done/templates/UI-SPEC.md`
