...
<!-- For checkpoint task examples and patterns, see @.agents/plugins/get-shit-done/get-shit-done/references/checkpoints.md -->
...
See `.agents/plugins/get-shit-done/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `.agents/plugins/get-shit-done/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `.agents/plugins/get-shit-done/get-shit-done/workflows/verify-phase.md` for verification logic.
