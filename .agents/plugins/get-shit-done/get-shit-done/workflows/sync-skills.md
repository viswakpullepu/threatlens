...
INSTALL_JS_GLOBAL=".agents/plugins/get-shit-done/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node .agents/plugins/get-shit-done/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
