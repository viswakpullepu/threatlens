...
```
Agent(
  prompt="Read .agents/plugins/get-shit-done/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `.agents/plugins/get-shit-done/get-shit-done/templates/SECURITY.md`
