...
Key references:
- @.agents/plugins/get-shit-done/get-shit-done/references/ui-brand.md (display patterns)
- @.agents/plugins/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @.agents/plugins/get-shit-done/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md"
...
```bash
cp ".agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md" ".agents/plugins/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `.agents/plugins/get-shit-done/get-shit-done/references/user-profiling.md`
...
Reference: @.agents/plugins/get-shit-done/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to .agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global GEMINI.md" -- "Add profile to .agents/plugins/get-shit-done/GEMINI.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at .agents/plugins/get-shit-done/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to .agents/plugins/get-shit-done/GEMINI.md"
...
```bash
BACKUP_PATH=".agents/plugins/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    .agents/plugins/get-shit-done/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   .agents/plugins/get-shit-done/skills/gsd-dev-preferences/SKILL.md
  ✓ GEMINI.md section       ./GEMINI.md
  ✓ Global GEMINI.md        .agents/plugins/get-shit-done/GEMINI.md
```
