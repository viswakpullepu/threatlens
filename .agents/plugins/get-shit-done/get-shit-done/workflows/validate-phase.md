...
```
Agent(
  prompt="Read .agents/plugins/get-shit-done/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `.agents/plugins/get-shit-done/get-shit-done/templates/VALIDATION.md`
