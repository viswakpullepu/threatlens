...
```bash
INIT=$(node ".agents/plugins/get-shit-done/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node ".agents/plugins/get-shit-done/get-shit-done/bin/gsd-tools.cjs" commit \
