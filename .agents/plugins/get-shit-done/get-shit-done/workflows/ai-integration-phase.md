...
<required_reading>
@.agents/plugins/get-shit-done/get-shit-done/references/ai-frameworks.md
@.agents/plugins/get-shit-done/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp ".agents/plugins/get-shit-done/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-eval-planner.md for instructions.
