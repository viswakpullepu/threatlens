...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-ui-researcher.md for instructions.
...
Template: .agents/plugins/get-shit-done/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read .agents/plugins/get-shit-done/agents/gsd-ui-checker.md for instructions.
