...
```bash
INIT=$(node ".agents/plugins/get-shit-done/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @.agents/plugins/get-shit-done/get-shit-done/templates/spec.md.
