...
<template>
@.agents/plugins/get-shit-done/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.agents/plugins/get-shit-done/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.agents/plugins/get-shit-done/get-shit-done/workflows/transition.md`.
...
- Follow @.agents/plugins/get-shit-done/get-shit-done/workflows/diagnose-issues.md
