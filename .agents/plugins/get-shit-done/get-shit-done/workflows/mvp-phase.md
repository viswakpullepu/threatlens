...
<required_reading>
@.agents/plugins/get-shit-done/get-shit-done/references/user-story-template.md
@.agents/plugins/get-shit-done/get-shit-done/references/spidr-splitting.md
@.agents/plugins/get-shit-done/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@.agents/plugins/get-shit-done/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@.agents/plugins/get-shit-done/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@.agents/plugins/get-shit-done/get-shit-done/references/spidr-splitting.md`. Briefly:
