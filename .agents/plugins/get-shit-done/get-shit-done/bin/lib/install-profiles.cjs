 ...
 *
 * @param {string} runtimeConfigDir absolute path (e.g. .agents/plugins/get-shit-done/skills)
 ...
 * @param {string} opts.targetDir runtime config dir (e.g. .agents/plugins/get-shit-done)
