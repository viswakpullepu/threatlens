...
- @.agents/plugins/get-shit-done/get-shit-done/workflows/complete-milestone.md (main workflow)
- @.agents/plugins/get-shit-done/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
